...
const article: Article = {
    ...
    user: {
        id: '1',
        username: 'admin',
        avatar: 'https://wordpress-s3websitefiles-qe2pg7xcae3.s3.us-east-2.amazonaws.com/wordpress/wp-content/uploads/2019/11/26160520/Male.jpg',
    },
    type: [ArticleType.IT],
    blocks: [
        {
...
NormalSmall.args = { article, view: ArticleView.SMALL };

export const NormalBig = Template.bind({});
NormalBig.args = { article, view: ArticleView.BIG };
